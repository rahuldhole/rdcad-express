...
const steps = [
  ...
  },
  {
    ...
    title: "3. Copy CAD Command (Recommended)",
    description: "The fastest way to get your drawing into CAD is by using the 'Copy CAD Command' feature. Click the copy icon in the toolbar, switch to your local AutoCAD window, paste the script directly into the command line, and press Enter. The drawing will generate instantly at your cursor."
  },
  {
    icon: <Download className="w-8 h-8 text-emerald-500" />,
    title: "4. Export DXF",
    description: "Alternatively, if you want to save the file or share it with a colleague, click 'Export DXF'. A standard .dxf file will download to your device, which is compatible with almost all drafting and 3D modeling software."
  },
  {
    icon: <Code className="w-8 h-8 text-rose-500" />,
    title: "5. Generate BBS & Reports",
      ...
      <div className="max-w-5xl mx-auto px-6 pt-24 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Master the RDCAD Express workflow in 5 simple steps and drastically reduce your drafting time.
          </p>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-6">
          <div className="p-8 bg-card border border-border rounded-2xl">
            <h4 className="text-xl font-bold mb-2">Need to install the LISP extension?</h4>
