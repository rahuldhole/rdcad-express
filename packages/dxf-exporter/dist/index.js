...
exports.exportDeskDXF = exportDeskDXF;
exports.exportConferenceTableDXF = exportConferenceTableDXF;
exports.exportToiletDXF = exportToiletDXF;
exports.exportSinkDXF = exportSinkDXF;
exports.exportTreeDXF = exportTreeDXF;
...
// ==========================================
function exportDeskDXF() {
    const dxf = new dxf_writer_1.default();
    dxf.addLayer('FURNITURE', dxf_writer_1.default.ACI.YELLOW, 'CONTINUOUS');
...
function exportConferenceTableDXF() {
    const dxf = new dxf_writer_1.default();
    dxf.addLayer('FURNITURE', dxf_writer_1.default.ACI.YELLOW, 'CONTINUOUS');
    dxf.setActiveLayer('FURNITURE');
    const width = 3000;
...
function exportToiletDXF() {
    const dxf = new dxf_writer_1.default();
    dxf.addLayer('PLUMBING', dxf_writer_1.default.ACI.CYAN, 'CONTINUOUS');
...
// ==========================================
function exportTreeDXF() {
    const dxf = new dxf_writer_1.default();
    dxf.addLayer('LANDSCAPING', dxf_writer_1.default.ACI.GREEN, 'CONTINUOUS');
...
function exportParkingBaysDXF() {
    const dxf = new dxf_writer_1.default();
    dxf.addLayer('SITE', dxf_writer_1.default.ACI.WHITE, 'CONTINUOUS');
...
function exportVehicleDXF() {
    const dxf = new dxf_writer_1.default();
    dxf.addLayer('SITE', dxf_writer_1.default.ACI.CYAN, 'CONTINUOUS');
    dxf.setActiveLayer('SITE');
    const width = 1800;
    const length = 4500;
